...
function FriendListItem:ctor()
    ...
    display.newScale9Sprite("#common_divLineSplit.png")
...
function FriendListItem:createContent_()
    ...
    -- 触摸头像删除好友
    self.deleteFriendButton = cc.ui.UIPushButton.new({normal = "#common_modTransparent.png", pressed = "#common_modTransparent.png"}, {scale9 = true})
