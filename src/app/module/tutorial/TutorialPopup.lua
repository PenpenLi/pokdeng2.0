...
local ImageWidth = 850
local ImageHeight = 352
...
function TutorialPopup:setupView()
    ...
    self.titleLabel_ = display.newTTFLabel({
    ...
    --触摸区域
    self.touchNode_ = display.newScale9Sprite("#common_modTransparent.png"):size(ImageWidth, ImageHeight):addTo(self)
