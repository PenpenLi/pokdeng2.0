...
local DealerBuyInPopup = class("DealerBuyInPopup", nk.ui.Panel)
...
function DealerBuyInPopup:ctor(param)
    DealerBuyInPopup.super.ctor(self, {WIDTH, HEIGHT})
...
function DealerBuyInPopup:onThumbTouch_(evt)
...
function DealerBuyInPopup:onEnterFrame_()
    if self.posPercent_ <= self.myMoneyPercent_ then
...
function DealerBuyInPopup:onSliderPercentValueChanged_(newVal, forceUpdate, needSound)
...
function DealerBuyInPopup:showPanel()
    self:showPanel_(true, true, true, true)
end

function DealerBuyInPopup:hidePanel()
    self:hidePanel_()
end

function DealerBuyInPopup:onEnter()
...
function DealerBuyInPopup:onExit()
...
function DealerBuyInPopup:onMoneyChanged_(money)
