...
local AddDealerAnteMoneyPopup = class("AddDealerAnteMoneyPopup", nk.ui.Panel)
...
function AddDealerAnteMoneyPopup:ctor(param)
    AddDealerAnteMoneyPopup.super.ctor(self, {WIDTH, HEIGHT})
...
function AddDealerAnteMoneyPopup:onThumbTouch_(evt)
...
function AddDealerAnteMoneyPopup:onEnterFrame_()
    if self.posPercent_ <= self.myMoneyPercent_ then
...
function AddDealerAnteMoneyPopup:onSliderPercentValueChanged_(newVal, forceUpdate, needSound)
...
function AddDealerAnteMoneyPopup:showPanel()
    self:showPanel_(true, true, true, true)
end

function AddDealerAnteMoneyPopup:hidePanel()
    self:hidePanel_()
end

function AddDealerAnteMoneyPopup:onEnter()
...
function AddDealerAnteMoneyPopup:onExit()
...
function AddDealerAnteMoneyPopup:onMoneyChanged_(money)
...
return AddDealerAnteMoneyPopup