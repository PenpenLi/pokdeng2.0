...
function DealerSeatView:ctor(ctx, seatId)
    ...
    --2 桌子背景
    --self.background_ = display.newScale9Sprite("#room_seat_bg.png", 0, 0, CCSize(DealerSeatView.WIDTH, DealerSeatView.HEIGHT)):addTo(self, 2)
...
function DealerSeatView:playAutoBuyinAnimation(buyinChips)
    ...
    local buyInLabelSequence = transition.sequence({
            spawn({
                ...
                CCMoveTo:create(1, cc.p(0, DealerSeatView.HEIGHT/2 - buyInBgSize.height/2 - buyInLabelPaddding)),
            }),
            cc.CallFunc:create(function()
