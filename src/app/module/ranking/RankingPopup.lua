...
function RankingPopup:createNodes_()
    ...
    self.line_ = display.newScale9Sprite("#common_divLineSplit.png")
        :pos(0, self.height_/2 - (nk.ui.CommonPopupTabBar.TAB_BAR_HEIGHT + SUB_TAB_SPACE))
        :addTo(self)
        :size(lineWidth, lineHeight)

    local touchCover = display.newScale9Sprite("#common_modTransparent.png", 0, self.height_ * 0.5 - 68, cc.size(self.width_, 136)):addTo(self, 9)
