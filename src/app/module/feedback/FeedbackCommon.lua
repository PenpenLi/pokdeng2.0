...
-- Description: FeedbackCommon.lua ReConstructed By Tsing7x.
-- 
...
function FeedbackCommon.initFeedback(callback)
    ...
    nk.http.post_url(feedBackUrl, params, function(data)
            ...
            -- {"time":1433747919,"ret":{"categories":[{"ctid":"402","ctgameid":"sg","ctlanguage":"tl","ctname":"\u767b\u9646\u95ee\u9898","ctpriority":"0",
            -- "ctprompt":"\u65e0\u6cd5\u767b\u9646\u6e38\u620f\u6216\u8005\u8fdb\u5165\u6e38\u620f\u8fc7\u6162","ctgamesubmit":"0","ctgameprompt":"",
            -- "ctsearch":"0","ctactive":"1","ctposition":"100","ctcreatetime":"0","ctupdatetime":null,
            -- "url":"http:\/\/apps.facebook.com\/twtexas\/feednew.php?ref=submit02.php?ctid="}],
            -- "urls":{"faqurl":"http:\/\/apps.facebook.com\/twtexas\/faqnew.php?ref=index.php?a=a",
            -- "myurl":"http:\/\/apps.facebook.com\/twtexas\/feednew.php?ref=my.php?a=a",
            -- "myallurl":"http:\/\/apps.facebook.com\/twtexas\/feednew.php?ref=my.php?a=a"}},"flag":1}
...
function FeedbackCommon.uploadPic(fid, picPath, callback)
    ...
    end, feedBackUrl, {fileFieldName = "pfile", filePath = picPath, contentType = "Image/jpeg", extra={{"api",json.encode(getParams("Feedback.mSendFeedBackPicture",
        postParams))}}})
end
...
function FeedbackCommon.getFeedbackList(callback, postExt)
    ...
    local params = {api = json.encode(post_data)}
