...
-- module app.module.store.services.GGPayPurchaseService.lua
-- Author: vanfo
...
local GGPayPurchaseService = class("GGPayPurchaseService", import("app.module.store.PurchaseServiceBase"))
