...
function ChipFrChgWareItem:initViews()
	...
	self._thLineOldChipNum = display.newScale9Sprite("#payGuide_lineTh.png", self._oldChipNumTTF:getContentSize().width / 2, self._oldChipNumTTF:getContentSize().height / 2,
		cc.size(self._oldChipNumTTF:getContentSize().width + lineShownEachSide * 2, thLineHeight))
		:addTo(self._oldChipNumTTF)

	self._thLineOldAvgChipNum = display.newScale9Sprite("#payGuide_lineTh.png", self._oldAvgChipNumTTF:getContentSize().width / 2, self._oldAvgChipNumTTF:getContentSize().height / 2,
		cc.size(self._oldAvgChipNumTTF:getContentSize().width, thLineHeight))
		:addTo(self._oldAvgChipNumTTF)
	-- end --
