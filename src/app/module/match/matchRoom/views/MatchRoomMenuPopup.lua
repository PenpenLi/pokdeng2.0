...
--
local MatchRoomMenuPopup = class("MatchRoomMenuPopup", function() return display.newNode() end)
...
function MatchRoomMenuPopup:ctor(callback)
    ...
    self.backToHallBtn_ = cc.ui.UIPushButton.new({normal="#common_modTransparent.png", pressed="#room_menu_pressed_top.png"}, {scale9=true})
    ...
    self.changeRoomBtn_ = cc.ui.UIPushButton.new({normal="#common_modTransparent.png", pressed="#room_menu_pressed_middle.png"}, {scale9=true})
        :setButtonSize(ITEM_WIDTH, ITEM_HEIGHT)
        :onButtonPressed(function() 
    ...
    self.settingUserinfoBtn_ = cc.ui.UIPushButton.new({normal="#common_modTransparent.png", pressed="#room_menu_pressed_middle.png"}, {scale9=true})
        :setButtonSize(ITEM_WIDTH, ITEM_HEIGHT)
        :onButtonPressed(function() 
    ...
    self.settingBtn_ = cc.ui.UIPushButton.new({normal="#common_modTransparent.png", pressed="#room_menu_pressed_bottom.png"}, {scale9=true})
        :setButtonSize(ITEM_WIDTH, ITEM_HEIGHT)
        :onButtonPressed(function() 
...
function MatchRoomMenuPopup:showPanel()
    nk.PopupManager:addPopup(self, true, false, true, false)
    return self
end

function MatchRoomMenuPopup:hidePanel(immediatlyClose)
    self.immediatlyClose_ = immediatlyClose
    nk.PopupManager:removePopup(self)
end

function MatchRoomMenuPopup:onShowPopup()
    self:stopAllActions()
...
function MatchRoomMenuPopup:onRemovePopup(removeFunc)
    self:stopAllActions()
