...
--
local MatchRoomViewPosition = {}
local P = MatchRoomViewPosition
...
P.DealCardPosition = {
    ...
    cc.p(P.SeatPosition[10].x + 40         , P.SeatPosition[10].y - 100)      
}
...
P.DealCardStartPosition = {
    ...
    cc.p(display.cx               , P.SeatPosition[1].y - 104-30)
}
...
-- dealer位置（10号位为荷官位置）
P.SpeakerPosition = {
    cc.p(715 - 480 + display.cx, 425 - 320 + display.cy-30), 
    cc.p(775 - 480 + display.cx, 400 - 320 + display.cy-30), 
    cc.p(775 - 480 + display.cx, 340 - 320 + display.cy-30), 
    cc.p(725 - 480 + display.cx, 280 - 320 + display.cy-30), 
    cc.p(460 - 480 + display.cx, 280 - 320 + display.cy-30),
    cc.p(230 - 480 + display.cx, 280 - 320 + display.cy-30),
    cc.p(180 - 480 + display.cx, 340 - 320 + display.cy-30),
    cc.p(180 - 480 + display.cx, 400 - 320 + display.cy-30),
    cc.p(240 - 480 + display.cx, 425 - 320 + display.cy-30),
    cc.p(display.cx - 35         , P.SeatPosition[1].y - 100-30)
}

return MatchRoomViewPosition