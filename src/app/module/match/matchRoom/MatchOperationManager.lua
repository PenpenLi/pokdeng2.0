...
function MatchOperationManager:createNodes()
    ...
    self.oprBtn1_ = OperationButton.new(4):setLabel(LB_CHECK):pos(- oprBtnW * 2.5 - 2 * padding, 0):addTo(self.oprNode_)
    self.oprBtn2_ = OperationButton.new(5):setLabel(LB_CALL):pos(- oprBtnW * 1.5 - padding, 0):addTo(self.oprNode_)
    self.oprBtn3_ = OperationButton.new(4):setLabel(LB_RAISE):pos(-oprBtnW * 0.5, 0):addTo(self.oprNode_)
