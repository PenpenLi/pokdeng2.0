...
function MatchPopupTabBar:ctor(args)
    ...
    for i = 1, #args.btnText do
        if args.iconTexture then
            self.btnIcons_[i] = display.newSprite("#common_modTransparent"):pos(args.iconOffsetX, 0)
        ...
        self.subBtns_[i] = cc.ui.UIPushButton.new({normal = "#common_modTransparent.png"}, {scale9 = true})
