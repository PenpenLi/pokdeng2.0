...
function CornuFriendFarmItem:ctor(parent)
  ...
  self.parent_ = parent
    ...
    cc.ui.UIPushButton.new({normal = "#common_modTransparent.png", pressed = "#common_modTransparent.png"}, {scale9 = true})
    :setButtonSize(47, 47)
    :pos(23,30)
    ...
    :addTo(self)
    :hide()
    self.click_btn_ = cc.ui.UIPushButton.new({normal = "#common_modTransparent.png", pressed = "#common_modTransparent.png"}, {scale9 = true})
