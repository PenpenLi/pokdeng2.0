...
function CornuHomePageView:ctor(parent)
    ...
    self.editBtn_ = cc.ui.UIPushButton.new({normal = "#common_modTransparent.png", pressed = "#common_roundRect_grey.png"}, {scale9 = true})
   ...
   -- :onButtonClicked(buttontHandler(self, self.onEditBtn_))
    ...
    self.confirmBtn_ = cc.ui.UIPushButton.new({normal = "#common_modTransparent.png", pressed = "#common_roundRect_grey.png"}, {scale9 = true})
    :setButtonSize(110, 25)
    :align(display.TOP_LEFT)
    :pos(0,-NOTICE_HEIGHT/2 + 25)
    ...
    self.noticeEdit_ = cc.ui.UIInput.new({image = "#common_modTransparent.png",listener = handler(self, self.onNoticeEdit_), size = cc.size(110, 25)})
        :align(display.TOP_LEFT)
        --:pos(-NOTICE_WIDTH/2,NOTICE_HEIGHT/2-NOTICE_TITLE_H)
        :pos(0,-NOTICE_HEIGHT/2 + 25)
        :addTo(self.myNotice_)
