...
function CornuPopup:createNodes_()
	--大背景
	self.panelOverlay_ = display.newScale9Sprite("#common_modTransparent.png", 0, 0, cc.size(self.width_, self.height_ - (nk.ui.CommonPopupTabBar.TAB_BAR_HEIGHT + PADDING * 2)))
