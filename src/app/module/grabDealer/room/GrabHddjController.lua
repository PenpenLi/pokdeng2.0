...
function GrabHddjController:dispose()
...
function GrabHddjController:loadHddjNum()
    if not nk.userData.hddjNum then
        self:refreshHddjNum()
    end
end

function GrabHddjController:refreshHddjNum()
...
function GrabHddjController:playHddj(fromPositionId, toPositionId, hddjId, completeCallback)
...
function GrabHddjController:playHddjAnim(hddjId, fromPositionId, toPositionId, completeCallback)
    ...
    elseif self.loadingHddj_[hddjId] then
        ...
        display.addSpriteFrames("hddjs/hddj-" .. hddjId .. ".plist", "hddjs/hddj-" .. hddjId .. ".png", function(fileName, imgName)
            print(animName .. " texture loaded")
            if self.isDisposed_ then
                display.removeSpriteFramesWithFile("hddjs/hddj-" .. hddjId .. ".plist", "hddjs/hddj-" .. hddjId .. ".png")
            else
                local config = GrabHddjController.hddjConfig[hddjId]
...
function GrabHddjController:playHddjAnim_(hddjId, container, anim, fromPositionId, toPositionId, completeCallback)
...
function GrabHddjController:playTissue(fromPositionId, toPositionId, completeCallback)
...
function GrabHddjController:playEgg(fromPositionId, toPositionId, completeCallback)
...
function GrabHddjController:playKiss(fromPositionId, toPositionId, completeCallback)
