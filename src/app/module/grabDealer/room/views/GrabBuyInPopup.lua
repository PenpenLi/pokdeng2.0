...
local GrabBuyInPopup = class("GrabBuyInPopup", nk.ui.Panel)
...
function GrabBuyInPopup:ctor(param)
    GrabBuyInPopup.super.ctor(self, {WIDTH, HEIGHT})
...
function GrabBuyInPopup:onThumbTouch_(evt)
...
function GrabBuyInPopup:onEnterFrame_()
    if self.posPercent_ <= self.myMoneyPercent_ then
...
function GrabBuyInPopup:onSliderPercentValueChanged_(newVal, forceUpdate, needSound)
...
function GrabBuyInPopup:showPanel()
    self:showPanel_(true, true, true, true)
end

function GrabBuyInPopup:hidePanel()
    self:hidePanel_()
end

function GrabBuyInPopup:onEnter()
...
function GrabBuyInPopup:onExit()
...
function GrabBuyInPopup:onMoneyChanged_(money)
