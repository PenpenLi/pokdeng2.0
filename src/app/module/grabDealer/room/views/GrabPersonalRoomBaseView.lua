...
local GrabPersonalRoomBaseView = class("GrabPersonalRoomBaseView",function()
...
function GrabPersonalRoomBaseView:ctor(ctx)
	self.ctx = ctx
...
function GrabPersonalRoomBaseView:addDataObservers()
    -- body
...
function GrabPersonalRoomBaseView:setStoreDiscount(discount)
...
function GrabPersonalRoomBaseView:setRoomInfoText(roomInfo)
...
function GrabPersonalRoomBaseView:setChangeRoomButtonMode(mode)
    if mode == 1 then
...
function GrabPersonalRoomBaseView:refreshFirstChargeFavEntryUi(isOpen)
    -- body
    if not isOpen then
        --todo
...
function GrabPersonalRoomBaseView:refreshAlmRechargeFavEntryUi(isOn)
    -- body
    if not isOn then
        --todo
...
function GrabPersonalRoomBaseView:onStandupClick_()
...
function GrabPersonalRoomBaseView:onShopClick_()
    if self.ctx.scene["onShopClick_"] then
		self.ctx.scene:onShopClick_()
	end
end

function GrabPersonalRoomBaseView:_onChargeFavCallBack()
    -- body
...
function GrabPersonalRoomBaseView:onAlmRechargeFavCallBack_(evt)
    -- body
...
function GrabPersonalRoomBaseView:onCleanup()
    -- body
...
return GrabPersonalRoomBaseView