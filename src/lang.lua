...
L.HALL.PERSONALROOM_CREATEINS = {
    T("房间名称: "),
    T("房间底注: "),
    T("房间密码: ")
}

L.HALL.PERSONALROOM_CREATEINSBOT = {
    T("赢家服务费: "),
    T("房间最小进入: ")  
}

L.HALL.PERSONALROOM_HINTROOMNAME = T("输入房间名称")
L.HALL.PERSONALROOM_HINTROOMPSW = T("请输入6位数密码")
L.HALL.PERSONALROOM_HINTROOMPSWNONE = T("(不填则没有密码)")
...
L.SUONA.USE_MAIN_TIPS = {
    T("1.每发送一条全服小喇叭需花费10M筹码"),  -- 1.ทุกครั้งที่ส่งลำโพง 1 ข้อความทั่วเซิร์ฟ ต้องจ่าย 10M ชิป
    T("2.每人每3分钟内只可发放一条全服小喇叭"),  -- 2.ทุกๆ 3 นาทีสามารถส่งลำโพงทั่วเซิร์ฟได้ 1 ข้อความเท่านั้น/คน
    T("3.在线的人均可看到喇叭发言，大胆告白吧")  -- 3.ผู้เล่นที่ออนไลน์ทุกท่านสามารถมองเห็นข้อความจากลำโพงได้  อยากบอกอะไรก็เขียนเลย
}

L.SUONA.USE_TIP_BOTTOM = T("合理使用全服喇叭  注意文明发言")  -- กรุณาใช้ลำโพงอย่างเหมาะสม และเขียนด้วยข้อความที่สุภาพเท่านั้น
...
L.DOKB.ATTENED_COST = T("确定花费{1}现金币 + {1}筹码参与此次夺宝吗？")
