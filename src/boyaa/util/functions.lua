...
function functions.formatNumberWithCurrenySfx(num, currencyStr)
    -- body
    return functions.formatBigNumber(num) .. currencyStr
end

function functions.formatNumberWithCurrenyPfx(num, currencyStr)
    -- body
    return currencyStr .. functions.formatNumberWithSplit(num)
end
...
-- @param tag: Format Tag, 1:Format-> mm:ss 2:Format-> hh:mm:ss 3：-> dd
